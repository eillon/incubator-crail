...
public class CrailConstants {
    ...
    public static final String STORAGE_DRAM_RATE_RATIO_KEY = "crail.storage.dram.rateratio";
    public static double STORAGE_DRAM_RATE_RATIO = 12300;

    public static final String STORAGE_NVM_MAX_IO_RATE_KEY = "crail.storage.dram.maxiorate";
    public static double STORAGE_NVM_MAX_IO_RATE = 480;
    ...
    public static void updateConstants(CrailConfiguration conf) {
        ...
        if (conf.get(STORAGE_DRAM_MAX_IO_RATE_KEY) != null) {
            STORAGE_DRAM_MAX_IO_RATE = Double.parseDouble(conf.get(STORAGE_DRAM_MAX_IO_RATE_KEY));
        }
        if (conf.get(STORAGE_DRAM_RATE_RATIO_KEY) != null) {
            STORAGE_DRAM_RATE_RATIO = Double.parseDouble(conf.get(STORAGE_DRAM_RATE_RATIO_KEY));
        }
        if (conf.get(STORAGE_NVM_MAX_IO_RATE_KEY) != null) {
            STORAGE_NVM_MAX_IO_RATE = Double.parseDouble(conf.get(STORAGE_NVM_MAX_IO_RATE_KEY));
        }
    ...
    public static void printConf() {
        ...
        LOG.info(STORAGE_DRAM_MAX_IO_RATE_KEY + " " + STORAGE_DRAM_MAX_IO_RATE);
