...
public abstract class CrailStore {
	...
	public abstract Upcoming<CrailNode> create(String path, CrailNodeType type, CrailStorageClass storageClass, CrailLocationClass locationClass, double Mt, boolean enumerable) throws Exception;
