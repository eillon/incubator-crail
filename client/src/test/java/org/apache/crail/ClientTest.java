...
public class ClientTest {
    ...
    public void init() throws Exception {
        ...
        fs.create(basePath, CrailNodeType.DIRECTORY, CrailStorageClass.DEFAULT, CrailLocationClass.DEFAULT, 10, true).get();
    }
    ...
    public void testCreateFile() throws Exception {
        ...
        fs.create(filename, CrailNodeType.DATAFILE, CrailStorageClass.DEFAULT, CrailLocationClass.DEFAULT, 10, true).get();
    ...
    public void testRenameFile() throws Exception {
        ...
        fs.create(srcname, CrailNodeType.DATAFILE, CrailStorageClass.DEFAULT, CrailLocationClass.DEFAULT, 10, true).get();
    ...
    public void testCreateDirectory() throws Exception {
        ...
        fs.create(filename, CrailNodeType.DIRECTORY, CrailStorageClass.DEFAULT, CrailLocationClass.DEFAULT, 10, true).get();
    ...
    void directStream(int length, int position, int remoteOffset) throws Exception {
        ...
        CrailFile file = fs.create(filename, CrailNodeType.DATAFILE, CrailStorageClass.DEFAULT, CrailLocationClass.DEFAULT, 10, true).get().asFile();
